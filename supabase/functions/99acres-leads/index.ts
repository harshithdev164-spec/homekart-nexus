...
serve(async (req) => {
  ...
  try {
    ...
    // Simulate 99acres API call (replace with actual API integration)
    const mockLeadData = {
      name: "Jane Smith",
      phone: "+91-9876543211",
      ...
      budget_max: 6000000,
      property_type: "villa",
      notes: "Looking for independent villa in Delhi NCR"
    };
    ...
    if (profiles && profiles.length > 0) {
      ...
      return new Response(
        JSON.stringify({ 
          success: true, 
          lead: newLead,
          message: 'Lead imported from 99acres successfully' 
        }),
        { 
