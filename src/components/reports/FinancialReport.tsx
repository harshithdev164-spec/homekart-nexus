...
export const FinancialReport: React.FC = () => {
  ...
  const [reportType, setReportType] = useState<'revenue_tracking' | 'commission'>('revenue_tracking');
  ...
  const generateReportData = async () => {
    ...
    try {
      ...
      const config: ReportConfig = {
        name: reportType === 'revenue_tracking' ? 'Revenue Tracking Report' : 'Commission Report',
        category: 'financial',
        type: reportType,
        filters: {
          timeRange,
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Revenue tracking and commission analysis</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <Tabs value={reportType} onValueChange={(value) => setReportType(value as any)}>
              <TabsList>
                <TabsTrigger value="revenue_tracking">Revenue Tracking</TabsTrigger>
