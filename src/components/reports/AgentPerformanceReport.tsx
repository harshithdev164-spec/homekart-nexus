  ...
  const generateReportData = async () => {
    ...
    try {
      ...
      const config: ReportConfig = {
        ...
        fields: ['agentName', 'calls', 'visits', 'leads', 'deals', 'revenue', 'conversionRate'],
        chartType: 'bar',
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Activity metrics, conversion rates, and revenue by agent</CardDescription>
        </CardHeader>
        <CardContent>
